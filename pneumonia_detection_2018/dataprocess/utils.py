...
def save_file2csvclassify(file_dir, file_name, labelnum):
    """
    save file path to csv
    :param file_dir:preprocess data path
    :param file_name:output csv name
    ...
    file_image_dir = file_dir
    file_paths = file_name_path(file_image_dir, dir=False, file=True)
    for index in range(len(file_paths)):
        out_file_image_path = file_image_dir + "/" + file_paths[index]
        out.writelines(str(labelnum) + "," + out_file_image_path + "\n")


if __name__ == '__main__':
    # save_file2csv(r"E:\MedicalData\kagglechallenge\pneumonia_detection_2018\segmentation", "segmeatationdata.csv")
    # save_file2csvclassify(r"E:\MedicalData\kagglechallenge\pneumonia_detection_2018\classify\0", "classifydata0.csv", 0)
    # save_file2csvclassify(r"E:\MedicalData\kagglechallenge\pneumonia_detection_2018\classify\1", "classifydata1.csv", 1)
    save_file2csvclassify(r"E:\MedicalData\kagglechallenge\pneumonia_detection_2018\classify\aug\1",
                          "traindata1aug.csv", 1)
    print('success')
