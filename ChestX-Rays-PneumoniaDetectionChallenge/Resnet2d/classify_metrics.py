...
def classify_metric_message(predict_label_file):
    ...
    true_labels_zero = true_labels.copy()
    true_labels_zero[true_labels == 0] = 0
    true_labels_zero[true_labels != 0] = 1
    predict_probs_zero = predict_labels.copy()
    predict_probs_zero[predict_labels == 0] = 0
    predict_probs_zero[predict_labels != 0] = 1
    print(roc_auc_scores(true_labels_zero, predict_probs_zero))
    print("roc_auc_score:one label")
    true_labels_one = true_labels.copy()
    true_labels_one[true_labels == 1] = 1
    true_labels_one[true_labels != 1] = 0
    predict_probs_one = predict_labels.copy()
    predict_probs_one[predict_labels == 1] = 1
    predict_probs_one[predict_labels != 1] = 0
    print(roc_auc_scores(true_labels_one, predict_probs_one))
    print("roc_auc_score:two label")
    true_labels_two = true_labels.copy()
    true_labels_two[true_labels == 2] = 1
    true_labels_two[true_labels != 2] = 0
    predict_probs_two = predict_labels.copy()
    predict_probs_two[predict_labels == 2] = 1
    predict_probs_two[predict_labels != 2] = 0
    print(roc_auc_scores(true_labels_two, predict_probs_two))
